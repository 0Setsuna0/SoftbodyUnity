...
public class sfb2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        TriggerCollider.center = childMeshBounds.center;
        TriggerCollider.size = childMeshBounds.size;
        ...
        InitializePointMassPositionsToBoundingBox(childMeshBounds.center, childMeshBounds.size / 2);
        ...
        //
        HullRestVolume = childMeshBounds.size.x * childMeshBounds.size.y * childMeshBounds.size.z;
    ...
    private void InitializePointMassPositionsToBoundingBox(Vector3 boundsCenter, Vector3 boundsHalfSize)
    {
        ...
        PointMassPositions[0] = transform.position + boundsCenter +
                                new Vector3(boundsHalfSize.x, boundsHalfSize.y, boundsHalfSize.z);
        PointMassPositions[1] = transform.position + boundsCenter +
                                new Vector3(boundsHalfSize.x, boundsHalfSize.y, -boundsHalfSize.z);
        PointMassPositions[2] = transform.position + boundsCenter +
                                new Vector3(-boundsHalfSize.x, boundsHalfSize.y, -boundsHalfSize.z);
        PointMassPositions[3] = transform.position + boundsCenter +
                                new Vector3(-boundsHalfSize.x, boundsHalfSize.y, boundsHalfSize.z);
        PointMassPositions[4] = transform.position + boundsCenter +
                                new Vector3(boundsHalfSize.x, -boundsHalfSize.y, boundsHalfSize.z);
        PointMassPositions[5] = transform.position + boundsCenter +
                                new Vector3(boundsHalfSize.x, -boundsHalfSize.y, -boundsHalfSize.z);
        PointMassPositions[6] = transform.position + boundsCenter +
                                new Vector3(-boundsHalfSize.x, -boundsHalfSize.y, -boundsHalfSize.z);
        PointMassPositions[7] = transform.position + boundsCenter +
                                new Vector3(-boundsHalfSize.x, -boundsHalfSize.y, boundsHalfSize.z);
    }
